...
class Plantilla(QWidget):
    ...
    def __init__(self, base_actual, parent=None):
        ...
        self.ui.treeView_carga_ips.setModel(self.modelo_sesion)
        self.ui.treeView_carga_ips.setRootIsDecorated(False)
        self.ui.treeView_carga_ips.setAlternatingRowColors(True)

        self.ui.treeView_carga_ips.setFocusPolicy(Qt.StrongFocus)
    ...
    def _init_autocompletado(self):
        self.autocomplete_campos = {
            ...
            self.ui.line_expediente: "expediente",
            self.ui.line_documento: "documento",
            self.ui.line_n_lote: "n_lote",
        }
    ...
    def _cargar_fila_completa(self, id_registro):
        ...
        try:
            ...
            if "n_lote" in campos_a_cargar:
                self.ui.line_n_lote.setText(datos["n_lote"] or "")           
            ...
            if "ultimo_movimiento" in campos_a_cargar:
                self.ui.line_ult_mov.setText(datos["ultimo_movimiento"] or "")            

        finally:
            self._actualizando = False
            self.lista_autocomplete.hide()

        self.ui.line_ult_mov.setFocus()
    ...
    def _validar_campos_obligatorios(self):
        ...
        campos = [
            ...
            ("N° Lote", self.ui.line_n_lote),            
            ("Ingreso", self.ui.line_ingreso),
            ("Egreso", self.ui.line_egreso),
            ("Últ. Movimiento", self.ui.line_ult_mov),            
        ]
    ...
    def guardar_registro(self):
        ...
        try:
            datos = [
                ...
                self.ui.line_n_lote.text(),                
                self.ui.line_ingreso.text(),
                self.ui.line_egreso.text(),
                self.ui.line_ult_mov.text()               
            ]
