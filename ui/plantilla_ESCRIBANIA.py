...
class Plantilla(QWidget):
    ...
    MAPEO_COLUMNAS_DB = {
            ...
            "Timbrado Fiscal": "timbrado_fiscal",
        }
    ...
    def __init__(self, base_actual, parent=None):
        ...
        self.ui.treeView_carga_escribania.setModel(self.modelo_sesion)
        self.ui.treeView_carga_escribania.setRootIsDecorated(False)
        self.ui.treeView_carga_escribania.setAlternatingRowColors(True)

        self.ui.treeView_carga_escribania.setFocusPolicy(Qt.StrongFocus)
    ...
    def _init_autocompletado(self):
        self.autocomplete_campos = {
            self.ui.line_nomb_apell: "nombre_apellido",
            self.ui.line_legajo: "legajo",
            self.ui.line_timb_fisc: "timbrado_fiscal",
            #self.ui.line_localidad: "localidad",
        }
        ...
        for line in (
            self.ui.line_nomb_apell,
            self.ui.line_legajo,
            self.ui.line_timb_fisc,
            #self.ui.line_localidad
        ):
    ...
    def _cargar_fila_completa(self, id_registro):
        ...
        try:
            ...
            datos = {
                ...
                "localidad": fila[5],
                "legajo": fila[6],                
                "nombre_apellido": fila[7],
                "timbrado_fiscal": fila[8],                             
            }
            ...
            if "nombre_apellido" in campos_a_cargar:
                self.ui.line_nomb_apell.setText(datos["nombre_apellido"] or "")                       

            if "timbrado_fiscal" in campos_a_cargar:
                self.ui.line_timb_fisc.setText(datos["timbrado_fiscal"] or "")            
    ...
    def _validar_campos_obligatorios(self):
        ...
        campos = [
            ...
            ("Nombre Apellido", self.ui.line_nomb_apell),   
            ("Timbrado Fiscal", self.ui.line_timb_fisc),
    ...
    def guardar_registro(self):
        ...
        try:
            datos = [
                ...
                self.ui.line_localidad.text(), 
                self.ui.line_legajo.text(),
                self.ui.line_nomb_apell.text(),
                self.ui.line_timb_fisc.text()   
            ]
    ...
    def limpiar_campos(self):
        ...
        self.ui.line_nomb_apell.clear()
        self.ui.line_timb_fisc.clear()

        self.ui.line_legajo.setFocus()

    def eliminar_registro(self):
        index = self.ui.treeView_carga_escribania.currentIndex()
