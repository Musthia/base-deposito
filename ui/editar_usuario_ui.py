...
################################################################################
## Form generated from reading UI file 'editar_usuario.ui'
##
...
class Ui_EditarUsuario(object):
    def setupUi(self, EditarUsuario):
        ...
        EditarUsuario.resize(320, 306)
        self.layoutWidget = QWidget(EditarUsuario)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(20, 10, 291, 284))
        ...
        self.gridLayout.addWidget(self.pushButton_cancelar, 12, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_reset_pass, 13, 3, 1, 1)

        self.pushButton_guardar = QPushButton(self.layoutWidget)
        self.pushButton_guardar.setObjectName(u"pushButton_guardar")

        self.gridLayout.addWidget(self.pushButton_guardar, 12, 1, 1, 1)
