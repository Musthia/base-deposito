...
# Proyecto / Modelo
# =========================
from model.datcorr_dao_pediatrico import DatcorrDAO
...
class Plantilla(QWidget):
    ...
    def __init__(self, base_actual, parent=None):
        ...
        # ---------- CONEXIÓN BOTÓN ----------
        self.ui.pushButton_guardar_carga_pediatrico.clicked.connect(
        ...
        self.ui.treeView_carga_pediatrico.setModel(self.modelo_sesion)
    ...
    def _cargar_fila_completa(self, id_registro):
        ...
        try:
            ...
            if "hh_cc" in campos_a_cargar:
                self.ui.line_hh_cc.setText(datos["hh_cc"] or "")              
    ...
    def eliminar_registro(self):
        index = self.ui.treeView_carga_pediatrico.currentIndex()
