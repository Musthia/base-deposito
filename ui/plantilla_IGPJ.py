...
class Plantilla(QWidget):
    ...
    def __init__(self, base_actual, parent=None):
        ...
        self.ui.treeView_carga_igpj.setModel(self.modelo_sesion)
        self.ui.treeView_carga_igpj.setRootIsDecorated(False)
        self.ui.treeView_carga_igpj.setAlternatingRowColors(True)

        self.ui.treeView_carga_igpj.setFocusPolicy(Qt.StrongFocus)
    ...
    def _init_autocompletado(self):
        self.autocomplete_campos = {
            ...
            #self.ui.line_departamento: "departamento",
    ...
    def _cargar_fila_completa(self, id_registro):
        ...
        try:
            ...
            if "departamento" in campos_a_cargar:
                self.ui.line_departamento.setText(datos["departamento"] or "")
    ...
    def _validar_campos_obligatorios(self):
        ...
        campos = [
            ...
            ("Departamento", self.ui.line_departamento),
            ("Expediente", self.ui.line_expediente),
            ("Estado", self.ui.line_estado),
            ("Caratula", self.ui.line_caratula),
    ...
    def guardar_registro(self):
        ...
        try:
            datos = [
                ...
                self.ui.line_departamento.text(),
    ...
    def limpiar_campos(self):
        ...
        self.ui.line_departamento.clear()
    ...
    def eliminar_registro(self):
        index = self.ui.treeView_carga_igpj.currentIndex()
